...
export default function CollagenProductPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ProductHero
        images={onePotImages}
        title="4 Potes de Colágeno Tipo 2 Active Plus + 2 Balm de Dores"
        originalPrice="R$ 717,70"
        currentPrice="R$ 239,90"
        installmentPrice="R$ 49,97"
        productType="tipo2"
        pixPrice="R$ 227,91 no pix"
      />
