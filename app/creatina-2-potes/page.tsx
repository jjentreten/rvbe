...
export default function CreatineMorningShotPage() {
  const creatineImages = [
    { src: "/creatina-2potes-1.webp", alt: "Kit 2 Creatina Morning Shot + Alívio Flex" },
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ProductHero
        ...
        title="2 Creatinas + Morning Shot + 1 Balm de Dores"
        originalPrice="R$ 329,90"
        currentPrice="R$ 114,90"
        installmentPrice="R$ 23,93"
        pixPrice="R$ 109,16 no pix"
      />
